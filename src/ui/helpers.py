...
def source_dataset_label(ds: str) -> str:
    labels = {
        ...
        # maternaqaes_lm estaba en DENSE_SOURCES pero sin etiqueta acá,
        # así que su id crudo ya aparecía en la píldora de fuentes.
        "maternaqaes_lm":        "Documento clínico obstétrico (ES)",
