...
Convierte un Markdown del proyecto (por defecto `docs/DOCUMENTACION.md`) a
PDF, con el mismo estilo visual del PDF de referencia (`docs/DOCUMENTACION.pdf`):
...
```bash
# Regenera docs/DOCUMENTACION.md -> docs/DOCUMENTACION.pdf (default)
node generate.mjs
...
Después de editar `docs/DOCUMENTACION.md` (secciones, tablas o
diagramas Mermaid), volvé a correr `node generate.mjs` para que
`docs/DOCUMENTACION.pdf` quede sincronizado. El script no se ejecuta
